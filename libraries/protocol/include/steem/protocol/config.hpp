...
#define SMT_MAX_ICO_EVALUATIONS_PER_BLOCK       (5)
#define SMT_MAX_ICO_LAUNCHES_PER_BLOCK          (5)
#define SMT_MAX_TOKEN_LAUNCHES_PER_BLOCK        (10)

#define SMT_REFUND_INTERVAL                     (STEEM_BLOCK_INTERVAL)
#define SMT_CONTRIBUTOR_PAYOUT_INTERVAL         (STEEM_BLOCK_INTERVAL)
