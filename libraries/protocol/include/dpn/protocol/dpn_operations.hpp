...
#include <dpn/protocol/legacy_asset.hpp>
...
namespace dpn { namespace protocol {
    ...
    *  @see SMT spec for details: https://github.com/dpnit/smt-whitepaper/blob/master/smt-manual/manual.md
    */
   struct allowed_vote_assets
   {
      ...
      void validate() const
      {
         ...
         FC_ASSERT(is_allowed(DPN_SYMBOL) == false,
            "DPN can not be explicitly specified as one of allowed_vote_assets");
      }
    ...
    *  The percent_dpn_dollars may be decreased, but never increased
    *
    */
   struct comment_options_operation : public base_operation
   {
      ...
      asset             max_accepted_payout    = asset( 1000000000, DBD_SYMBOL );       /// DBD value of the maximum payout this post will receive
      uint16_t          percent_dpn_dollars  = DPN_100_PERCENT; /// the percent of Dpn Dollars to key, unkept amounts will be received as Dpn Power
    ...
    * @ingroup operations
    *
    * @brief Transfers DPN from one account to another.
    */
   ...
   struct escrow_transfer_operation : public base_operation
   {
      ...
      asset             dbd_amount = asset( 0, DBD_SYMBOL );
      asset             dpn_amount = asset( 0, DPN_SYMBOL );
      asset             fee;
   ...
   struct escrow_release_operation : public base_operation
   {
      ...
      uint32_t          escrow_id = 30;
      asset             dbd_amount = asset( 0, DBD_SYMBOL ); ///< the amount of dbd to release
      asset             dpn_amount = asset( 0, DPN_SYMBOL ); ///< the amount of dpn to release
   ...
   /**
    *  This operation converts liquid token (DPN or liquid SMT) into VFS (Vesting Fund Shares,
   ...
   struct transfer_to_vesting_operation : public base_operation
   {
      ...
      asset             amount;  ///< must be DPN or liquid variant of SMT
    ...
    * vests to dpn and back, guaranteeing they maintain their value.
    */
   ...
   struct legacy_chain_properties
   {
       ...
       */
      legacy_dpn_asset account_creation_fee = legacy_dpn_asset::from_amount( DPN_MIN_ACCOUNT_CREATION_FEE );
      ...
      void validate()const
      {
         ...
         FC_ASSERT( account_creation_fee.amount >= DPN_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= DPN_MIN_BLOCK_SIZE_LIMIT);
         FC_ASSERT( dbd_interest_rate >= 0 );
         FC_ASSERT( dbd_interest_rate <= DPN_100_PERCENT );
      }
   };
   ...
   struct witness_set_properties_operation : public base_operation
   {
      ...
      void get_required_authorities( vector< authority >& a )const
      {
         ...
         if( key_itr != props.end() )
         {
            ...
            a.push_back( authority( 1, DPN_NULL_ACCOUNT, 1 ) ); // The null account auth is impossible to satisfy
      }
   };
    ...
    *  used to define the exchange rate between dpn and the dollar.
    */
   ...
   /**
    *  This operation instructs the blockchain to start a conversion between DPN and DBD,
    *  The funds are deposited after DPN_CONVERSION_DELAY
    */
    ...
    * DPN_MAX_WITNESSES blocks of the head block (1 round) and the
    * producer must be in the ACTIVE witness set.
    *
    * Users not in the ACTIVE witness set should not have to worry about their
    * key getting compromised and being used to produced multiple blocks so
    * the attacker can report it and steel their vesting dpn.
    *
    * The result of the operation is to transfer the full VESTING DPN balance
...
FC_REFLECT( dpn::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( dpn::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( dpn::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( dpn::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( dpn::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( dpn::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( dpn::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( dpn::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( dpn::protocol::pow, (worker)(input)(signature)(work) )
FC_REFLECT( dpn::protocol::pow2, (input)(pow_summary) )
FC_REFLECT( dpn::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
FC_REFLECT( dpn::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( dpn::protocol::legacy_chain_properties,
            (account_creation_fee)
            (maximum_block_size)
            (dbd_interest_rate)
          )

FC_REFLECT_TYPENAME( dpn::protocol::pow2_work )
FC_REFLECT( dpn::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
FC_REFLECT( dpn::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( dpn::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( dpn::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( dpn::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( dpn::protocol::account_update2_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( dpn::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( dpn::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( dpn::protocol::withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( dpn::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
FC_REFLECT( dpn::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( dpn::protocol::witness_set_properties_operation, (owner)(props)(extensions) )
FC_REFLECT( dpn::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( dpn::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( dpn::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( dpn::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( dpn::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( dpn::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( dpn::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( dpn::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( dpn::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( dpn::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( dpn::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( dpn::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( dpn::protocol::comment_payout_beneficiaries, (beneficiaries) )

#ifdef DPN_ENABLE_SMT
FC_REFLECT( dpn::protocol::votable_asset_info_v1, (max_accepted_payout)(allow_curation_rewards) )
FC_REFLECT( dpn::protocol::allowed_vote_assets, (votable_assets) )
#endif

FC_REFLECT_TYPENAME( dpn::protocol::comment_options_extension )
FC_REFLECT( dpn::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_dpn_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

FC_REFLECT( dpn::protocol::escrow_transfer_operation, (from)(to)(dbd_amount)(dpn_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( dpn::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
FC_REFLECT( dpn::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
FC_REFLECT( dpn::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(dbd_amount)(dpn_amount) );
FC_REFLECT( dpn::protocol::claim_account_operation, (creator)(fee)(extensions) );
FC_REFLECT( dpn::protocol::create_claimed_account_operation, (creator)(new_account_name)(owner)(active)(posting)(memo_key)(json_metadata)(extensions) );
FC_REFLECT( dpn::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
FC_REFLECT( dpn::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
FC_REFLECT( dpn::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
FC_REFLECT( dpn::protocol::decline_voting_rights_operation, (account)(decline) );
FC_REFLECT( dpn::protocol::claim_reward_balance_operation, (account)(reward_dpn)(reward_dbd)(reward_vests) )
#ifdef DPN_ENABLE_SMT
FC_REFLECT( dpn::protocol::claim_reward_balance2_operation, (account)(extensions)(reward_tokens) )
#endif
FC_REFLECT( dpn::protocol::delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
