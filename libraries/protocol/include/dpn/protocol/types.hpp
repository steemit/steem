...
namespace dpn {
   ...
   namespace protocol {
      ...
      #define DPN_INIT_PUBLIC_KEY (dpn::protocol::public_key_type(DPN_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const dpn::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  dpn::protocol::public_key_type& vo );
    void to_variant( const dpn::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, dpn::protocol::extended_public_key_type& vo );
    void to_variant( const dpn::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, dpn::protocol::extended_private_key_type& vo );
}

FC_REFLECT( dpn::protocol::public_key_type, (key_data) )
FC_REFLECT( dpn::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( dpn::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( dpn::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( dpn::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( dpn::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( dpn::protocol::share_type )

FC_REFLECT( dpn::void_t, )
