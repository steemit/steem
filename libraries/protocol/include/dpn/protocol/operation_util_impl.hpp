...
//
// Place DPN_DEFINE_OPERATION_TYPE in a .cpp file to define
// functions related to your operation type
//
#define DPN_DEFINE_OPERATION_TYPE( OperationType )                       \
                                                                           \
namespace dpn { namespace protocol {                                     \
                                                                           \
void operation_validate( const OperationType& op )                         \
{                                                                          \
   op.visit( dpn::protocol::operation_validate_visitor() );              \
}                                                                          \
                                                                           \
...
{                                                                          \
   op.visit( dpn::protocol::get_required_auth_visitor( active, owner, posting, other ) ); \
}                                                                          \
                                                                           \
} } /* dpn::protocol */
