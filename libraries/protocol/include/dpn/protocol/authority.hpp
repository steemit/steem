 ...
 * - Length is between (inclusive) DPN_MIN_ACCOUNT_NAME_LENGTH and DPN_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace dpn::protocol


FC_REFLECT_TYPENAME( dpn::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( dpn::protocol::authority::key_authority_map)
FC_REFLECT( dpn::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( dpn::protocol::authority::classification, (owner)(active)(key)(posting) )
