...
FC_REFLECT_TYPENAME( dpn::protocol::block_header_extensions )

FC_REFLECT( dpn::protocol::block_header, (previous)(timestamp)(witness)(transaction_merkle_root)(extensions) )
FC_REFLECT_DERIVED( dpn::protocol::signed_block_header, (dpn::protocol::block_header), (witness_signature) )
