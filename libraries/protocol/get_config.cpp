...
fc::variant_object get_config()
{
   ...
   result["SMT_MAX_ICO_LAUNCHES_PER_BLOCK"] = SMT_MAX_ICO_LAUNCHES_PER_BLOCK;
   result["SMT_MAX_ICO_EVALUATIONS_PER_BLOCK"] = SMT_MAX_ICO_EVALUATIONS_PER_BLOCK;
   result["SMT_MAX_TOKEN_LAUNCHES_PER_BLOCK"] = SMT_MAX_TOKEN_LAUNCHES_PER_BLOCK;
   result["SMT_REFUND_INTERVAL"] = SMT_REFUND_INTERVAL;
   result["SMT_CONTRIBUTOR_PAYOUT_INTERVAL"] = SMT_CONTRIBUTOR_PAYOUT_INTERVAL;
#else
