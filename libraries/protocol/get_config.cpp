...
fc::variant_object get_config()
{
   ...
   result["STEEMIT_ACTIVE_ROLE_NAME"] = STEEMIT_ACTIVE_ROLE_NAME;
   ...
   result["STEEMIT_OWNER_ROLE_NAME"] = STEEMIT_OWNER_ROLE_NAME;
   ...
   result["STEEMIT_POSTING_ROLE_NAME"] = STEEMIT_POSTING_ROLE_NAME;
