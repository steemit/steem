...
#include <dpn/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
{
   public:
      blockchain_statistics_api( const dpn::app::api_context& ctx );
...
FC_REFLECT( dpn::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( dpn::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
