...
namespace graphene { namespace db { namespace detail {
...
#define DECLARE_SCHEMA_CLASS( is_reflected, is_enum )           \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
SCHEMA_CLASS_BODY( schema_impl )                                \
};

#define SCHEMA_CLASS_BODY( CLASSNAME )                          \
...
DECLARE_SCHEMA_CLASS( false, false )
DECLARE_SCHEMA_CLASS(  true, false )
DECLARE_SCHEMA_CLASS(  true,  true )
