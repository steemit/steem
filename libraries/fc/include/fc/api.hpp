...
namespace fc {
  ...
  class api : public api_base {
    public:
      ...
      vtable_type& operator*()const  { FC_ASSERT( _vtable, "API not backed by a connection." ); return *_vtable; }
      vtable_type* operator->()const {  FC_ASSERT( _vtable, "API not back by a connection." ); return _vtable.get(); }
