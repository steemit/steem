...
#include <mira/detail/auto_space.hpp>
#include <mira/detail/raw_ptr.hpp>
...
class index_loader:private boost::noncopyable
{
public:
  ...
  {
    ar>>boost::serialization::make_nvp("position",*node);
    entries()[n++]=node;
  }
...
private:
  ...
  {
    Node* node=0;
    ar>>boost::serialization::make_nvp("pointer",node);
