...
struct is_transparent:boost::mpl::true_{};
...
template<typename F,typename Arg1,typename Arg2,typename=void>
struct is_transparent_class:boost::mpl::true_{};
...
struct is_transparent<
  ...
  typename enable_if<
    boost::mpl::and_<
      is_class<F>,
      boost::mpl::not_<is_final<F> > /* is_transparent_class_helper derives from F */
    >
  >::type
>:is_transparent_class<F,Arg1,Arg2>{};

template<typename F,typename Arg1,typename Arg2,typename=void>
struct is_transparent_function:boost::mpl::true_{};
