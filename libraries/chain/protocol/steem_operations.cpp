...
namespace steemit {
    namespace chain {
        ...
        void comment_operation::validate() const {
            ...
            FC_ASSERT(!parent_author.size() ||
                      is_valid_account_name(parent_author), "Parent author name invalid");
        ...
        void transfer_operation::validate() const {
            try {
                ...
                FC_ASSERT(amount.symbol !=
                          VESTS_SYMBOL, "transferring of Steem Power (STMP) is not allowed.");
