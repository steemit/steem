...
{
   _hardfork_times[ 0 ] = fc::time_point_sec( DPN_GENESIS_TIME );
   _hardfork_versions[ 0 ] = hardfork_version( 0, 0 );
   FC_ASSERT( DPN_HARDFORK_0_1 == 1, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_1 ] = fc::time_point_sec( DPN_HARDFORK_0_1_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_1 ] = DPN_HARDFORK_0_1_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_2 == 2, "Invlaid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_2 ] = fc::time_point_sec( DPN_HARDFORK_0_2_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_2 ] = DPN_HARDFORK_0_2_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_3 == 3, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_3 ] = fc::time_point_sec( DPN_HARDFORK_0_3_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_3 ] = DPN_HARDFORK_0_3_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_4 == 4, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_4 ] = fc::time_point_sec( DPN_HARDFORK_0_4_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_4 ] = DPN_HARDFORK_0_4_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_5 == 5, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_5 ] = fc::time_point_sec( DPN_HARDFORK_0_5_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_5 ] = DPN_HARDFORK_0_5_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_6 == 6, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_6 ] = fc::time_point_sec( DPN_HARDFORK_0_6_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_6 ] = DPN_HARDFORK_0_6_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_7 == 7, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_7 ] = fc::time_point_sec( DPN_HARDFORK_0_7_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_7 ] = DPN_HARDFORK_0_7_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_8 == 8, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_8 ] = fc::time_point_sec( DPN_HARDFORK_0_8_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_8 ] = DPN_HARDFORK_0_8_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_9 == 9, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_9 ] = fc::time_point_sec( DPN_HARDFORK_0_9_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_9 ] = DPN_HARDFORK_0_9_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_10 == 10, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_10 ] = fc::time_point_sec( DPN_HARDFORK_0_10_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_10 ] = DPN_HARDFORK_0_10_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_11 == 11, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_11 ] = fc::time_point_sec( DPN_HARDFORK_0_11_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_11 ] = DPN_HARDFORK_0_11_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_12 == 12, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_12 ] = fc::time_point_sec( DPN_HARDFORK_0_12_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_12 ] = DPN_HARDFORK_0_12_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_13 == 13, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_13 ] = fc::time_point_sec( DPN_HARDFORK_0_13_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_13 ] = DPN_HARDFORK_0_13_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_14 == 14, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_14 ] = fc::time_point_sec( DPN_HARDFORK_0_14_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_14 ] = DPN_HARDFORK_0_14_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_15 == 15, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_15 ] = fc::time_point_sec( DPN_HARDFORK_0_15_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_15 ] = DPN_HARDFORK_0_15_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_16 == 16, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_16 ] = fc::time_point_sec( DPN_HARDFORK_0_16_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_16 ] = DPN_HARDFORK_0_16_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_17 == 17, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_17 ] = fc::time_point_sec( DPN_HARDFORK_0_17_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_17 ] = DPN_HARDFORK_0_17_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_18 == 18, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_18 ] = fc::time_point_sec( DPN_HARDFORK_0_18_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_18 ] = DPN_HARDFORK_0_18_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_19 == 19, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_19 ] = fc::time_point_sec( DPN_HARDFORK_0_19_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_19 ] = DPN_HARDFORK_0_19_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_20 == 20, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_20 ] = fc::time_point_sec( DPN_HARDFORK_0_20_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_20 ] = DPN_HARDFORK_0_20_VERSION;
#ifdef IS_TEST_NET
   FC_ASSERT( DPN_HARDFORK_0_21 == 21, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_21 ] = fc::time_point_sec( DPN_HARDFORK_0_21_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_21 ] = DPN_HARDFORK_0_21_VERSION;
   FC_ASSERT( DPN_HARDFORK_0_22 == 22, "Invalid hardfork configuration" );
   _hardfork_times[ DPN_HARDFORK_0_22 ] = fc::time_point_sec( DPN_HARDFORK_0_22_TIME );
   _hardfork_versions[ DPN_HARDFORK_0_22 ] = DPN_HARDFORK_0_22_VERSION;
#endif
   ...
   FC_ASSERT( _hardfork_versions[ hardforks.last_hardfork ] <= DPN_BLOCKCHAIN_VERSION, "Blockchain version is older than last applied hardfork" );
   FC_ASSERT( DPN_BLOCKCHAIN_HARDFORK_VERSION >= DPN_BLOCKCHAIN_VERSION );
   FC_ASSERT( DPN_BLOCKCHAIN_HARDFORK_VERSION == _hardfork_versions[ DPN_NUM_HARDFORKS ] );
}
