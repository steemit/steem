...
fc::variant_object get_config()
{
   ...
   result["STEEMIT_CONTENT_APR"] = STEEMIT_CONTENT_APR;
   result["STEEMIT_CONVERSION_DELAY"] = STEEMIT_CONVERSION_DELAY;
   result["STEEMIT_CORE_ASSET_CYCLE_RATE"] = STEEMIT_CORE_ASSET_CYCLE_RATE;
   result["STEEMIT_CORE_ASSET_CYCLE_RATE_BITS"] = STEEMIT_CORE_ASSET_CYCLE_RATE_BITS;
   result["STEEMIT_CURATE_APR"] = STEEMIT_CURATE_APR;
   ...
   result["STEEMIT_FIRST_CASHOUT_TIME"] = STEEMIT_FIRST_CASHOUT_TIME;
   ...
   result["STEEMIT_LIQUIDITY_APR"] = STEEMIT_LIQUIDITY_APR;
   ...
   result["STEEMIT_POW_APR"] = STEEMIT_POW_APR;
   result["STEEMIT_PRODUCER_APR"] = STEEMIT_PRODUCER_APR;
