...
namespace dpn { namespace chain {
   ...
   {
      DPN_STD_ALLOCATOR_CONSTRUCTOR( comment_object )
      ...
      public:
         ...
         /** tracks the total payout this comment has received over time, measured in DBD */
         asset             total_payout_value = asset(0, DBD_SYMBOL);
         asset             curator_payout_value = asset(0, DBD_SYMBOL);
         asset             beneficiary_payout_value = asset( 0, DBD_SYMBOL );
   ...
   {
      DPN_STD_ALLOCATOR_CONSTRUCTOR( comment_content_object )
   ...
   {
      DPN_STD_ALLOCATOR_CONSTRUCTOR( comment_vote_object )
...
template<> struct is_static_length< dpn::chain::comment_vote_object > : public boost::true_type {};

} // mira
#endif

FC_REFLECT( dpn::chain::comment_object,
             (id)(author)(permlink)
...
CHAINBASE_SET_INDEX_TYPE( dpn::chain::comment_object, dpn::chain::comment_index )

FC_REFLECT( dpn::chain::comment_content_object,
            (id)(comment)(title)(body)(json_metadata) )
CHAINBASE_SET_INDEX_TYPE( dpn::chain::comment_content_object, dpn::chain::comment_content_index )

FC_REFLECT( dpn::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( dpn::chain::comment_vote_object, dpn::chain::comment_vote_index )

namespace helpers
{
   using dpn::chain::shared_string;

   template <>
   class index_statistic_provider<dpn::chain::comment_index>
   {
   public:
      typedef dpn::chain::comment_index IndexType;
      typedef typename dpn::chain::comment_object::t_beneficiaries t_beneficiaries;
#ifdef DPN_ENABLE_SMT
      typedef typename dpn::chain::comment_object::t_votable_assets t_votable_assets;
#endif
   ...
   template <>
   class index_statistic_provider<dpn::chain::comment_content_index>
   {
   public:
      typedef dpn::chain::comment_content_index IndexType;
