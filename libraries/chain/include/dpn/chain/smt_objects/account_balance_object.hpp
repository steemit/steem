...
{
   DPN_STD_ALLOCATOR_CONSTRUCTOR( account_regular_balance_object );
...
{
   DPN_STD_ALLOCATOR_CONSTRUCTOR( account_rewards_balance_object );
...
public:   
   ...
   /// Name of the account, the balance is held for.
   account_name_type   owner;
   asset               pending_liquid;          /// 'reward_dpn_balance' for pending DPN
   asset               pending_vesting_shares;  /// 'reward_vesting_balance' for pending VESTS
   asset               pending_vesting_value;   /// 'reward_vesting_dpn' for pending VESTS
...
FC_REFLECT( dpn::chain::account_regular_balance_object,
   (id)
   (owner)
   (liquid)
   (vesting)
...
FC_REFLECT( dpn::chain::account_rewards_balance_object,
   (id)
   (owner)
   (pending_liquid)
...
CHAINBASE_SET_INDEX_TYPE( dpn::chain::account_regular_balance_object, dpn::chain::account_regular_balance_index )
CHAINBASE_SET_INDEX_TYPE( dpn::chain::account_rewards_balance_object, dpn::chain::account_rewards_balance_index )
