...
namespace dpn { namespace chain {
   ...
   /**
    *  This object is used to track pending requests to convert dbd to dpn
    */
   ...
   {
      DPN_STD_ALLOCATOR_CONSTRUCTOR( savings_withdraw_object )
    ...
    *  1000 DPN or 1000 * virtual_supply / (100*blocks_per_year) aka 10 * virtual_supply / blocks_per_year
    *
   ...
   class liquidity_reward_balance_object : public object< liquidity_reward_balance_object_type, liquidity_reward_balance_object >
   {
      public:
         ...
         int64_t           dpn_volume = 0;
         int64_t           dbd_volume = 0;
         uint128_t         weight = 0;
         ...
         {
            return dpn_volume * dbd_volume * is_positive();
         }

         uint128_t min_volume_weight()const
         {
            return std::min(dpn_volume,dbd_volume) * is_positive();
         }
         ...
         {
            return ( dpn_volume > 0 && dbd_volume > 0 ) ? 1 : 0;
         }
   };
   ...
   {
      DPN_STD_ALLOCATOR_CONSTRUCTOR( feed_history_object )
...
template<> struct is_static_length< dpn::chain::convert_request_object > : public boost::true_type {};
template<> struct is_static_length< dpn::chain::escrow_object > : public boost::true_type {};
template<> struct is_static_length< dpn::chain::liquidity_reward_balance_object > : public boost::true_type {};
template<> struct is_static_length< dpn::chain::limit_order_object > : public boost::true_type {};
template<> struct is_static_length< dpn::chain::withdraw_vesting_route_object > : public boost::true_type {};
template<> struct is_static_length< dpn::chain::decline_voting_rights_request_object > : public boost::true_type {};
template<> struct is_static_length< dpn::chain::reward_fund_object > : public boost::true_type {};
...
FC_REFLECT( dpn::chain::limit_order_object,
             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
CHAINBASE_SET_INDEX_TYPE( dpn::chain::limit_order_object, dpn::chain::limit_order_index )

FC_REFLECT( dpn::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( dpn::chain::feed_history_object, dpn::chain::feed_history_index )

FC_REFLECT( dpn::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( dpn::chain::convert_request_object, dpn::chain::convert_request_index )

FC_REFLECT( dpn::chain::liquidity_reward_balance_object,
             (id)(owner)(dpn_volume)(dbd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( dpn::chain::liquidity_reward_balance_object, dpn::chain::liquidity_reward_balance_index )

FC_REFLECT( dpn::chain::withdraw_vesting_route_object,
             (id)(from_account)(to_account)(percent)(auto_vest) )
CHAINBASE_SET_INDEX_TYPE( dpn::chain::withdraw_vesting_route_object, dpn::chain::withdraw_vesting_route_index )

FC_REFLECT( dpn::chain::savings_withdraw_object,
             (id)(from)(to)(memo)(request_id)(amount)(complete) )
CHAINBASE_SET_INDEX_TYPE( dpn::chain::savings_withdraw_object, dpn::chain::savings_withdraw_index )

FC_REFLECT( dpn::chain::escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (dbd_balance)(dpn_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )
CHAINBASE_SET_INDEX_TYPE( dpn::chain::escrow_object, dpn::chain::escrow_index )

FC_REFLECT( dpn::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( dpn::chain::decline_voting_rights_request_object, dpn::chain::decline_voting_rights_request_index )

FC_REFLECT( dpn::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
CHAINBASE_SET_INDEX_TYPE( dpn::chain::reward_fund_object, dpn::chain::reward_fund_index )
