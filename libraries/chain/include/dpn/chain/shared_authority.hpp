...
namespace dpn { namespace chain {
   ...
   using dpn::protocol::weight_type;
   ...
   {
      DPN_STD_ALLOCATOR_CONSTRUCTOR( shared_authority )
...
FC_REFLECT_TYPENAME( dpn::chain::shared_authority::account_authority_map)
FC_REFLECT( dpn::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
