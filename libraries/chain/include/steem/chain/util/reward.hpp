...
uint128_t evaluate_reward_curve( const uint128_t& rshares, const protocol::curve_id& curve = protocol::quadratic, const uint128_t& var1 = STEEM_CONTENT_CONSTANT_HF0, const uint128_t& var2 = 0 );
