...
namespace steemit { namespace chain {
   ...
   class operation_object : public object< impl_operation_object_type, operation_object >
   {
      public:
         template< typename Constructor, typename Allocator >
         operation_object( Constructor&& c, allocator< Allocator > a )
            :serialized_op( bip::allocator< char, bip::managed_mapped_file::segment_manager >( a.get_segment_manager() ) )
         {
            c( *this );
         }
   ...
   typedef multi_index_container<
      operation_object,
      indexed_by<
         ordered_unique< tag< by_id >, member< operation_object, object_id_type, &operation_object::id > >,
         ordered_unique< tag< by_location >,
            composite_key< operation_object,
               ...
               member< operation_object, object_id_type, &operation_object::id>
            >
         >,
         ...
         >
      >,
      bip::allocator< operation_object, bip::managed_mapped_file::segment_manager >
   > operation_index;

   class account_history_object : public abstract_object< impl_account_history_object_type, account_history_object >
   {
      public:
         template< typename Constructor, typename Allocator >
   ...
   typedef multi_index_container<
      ...
      indexed_by<
         ordered_unique< tag< by_id >, member< account_history_object, object_id_type, &account_history_object::id > >,
         ...
         >
      >,
      bip::allocator< account_history_object, bip::managed_mapped_file::segment_manager >
