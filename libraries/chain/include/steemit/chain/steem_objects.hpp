...
namespace steemit {
    namespace chain {
        ...
        class convert_request_object
                : public abstract_object<convert_request_object> {
        public:
        ...
        class savings_withdraw_object
                : public abstract_object<savings_withdraw_object> {
        public:
            static const uint8_t space_id = implementation_ids;
        ...
        class liquidity_reward_balance_object
                : public abstract_object<liquidity_reward_balance_object> {
        public:
            static const uint8_t space_id = implementation_ids;
        ...
        class feed_history_object
                : public abstract_object<feed_history_object> {
        public:
            static const uint8_t space_id = implementation_ids;
        ...
        class withdraw_vesting_route_object
                : public abstract_object<withdraw_vesting_route_object> {
        public:
            static const uint8_t space_id = implementation_ids;
        ...
        class decline_voting_rights_request_object
                : public abstract_object<decline_voting_rights_request_object> {
        public:
            static const uint8_t space_id = implementation_ids;
