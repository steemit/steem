...
namespace steemit {
    namespace chain {
        ...
        class owner_authority_history_object
                : public abstract_object<owner_authority_history_object> {
        public:
            static const uint8_t space_id = implementation_ids;
            ...
            owner_authority_history_id_type get_id() const {
                return id;
            }
        };

        class account_recovery_request_object
                : public abstract_object<account_recovery_request_object> {
        public:
            static const uint8_t space_id = implementation_ids;
            ...
            account_recovery_request_id_type get_id() const {
                return id;
            }
        };

        class change_recovery_account_request_object
                : public abstract_object<change_recovery_account_request_object> {
        public:
            static const uint8_t space_id = implementation_ids;
            ...
            change_recovery_account_request_id_type get_id() const {
                return id;
            }
        };
