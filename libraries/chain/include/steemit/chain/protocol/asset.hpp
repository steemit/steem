...
namespace fc {
    inline void to_variant(const steemit::chain::asset &var, fc::variant &vo) {
        vo = var.to_string();
    }

    inline void from_variant(const fc::variant &var, steemit::chain::asset &vo) {
        vo = steemit::chain::asset::from_string(var.as_string());
    }
}

FC_REFLECT(steemit::chain::asset, (amount)(symbol))
FC_REFLECT(steemit::chain::price, (base)(quote))
