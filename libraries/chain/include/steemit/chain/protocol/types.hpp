...
namespace steemit { namespace chain {
   ...
   enum impl_object_type
   {
      ...
      impl_withdraw_vesting_destination_object_type
   };
   ...
   class withdraw_vesting_destination_object;
   ...
   typedef object_id< implementation_ids, impl_withdraw_vesting_destination_object_type,  withdraw_vesting_destination_object >  withdraw_vesting_destination_id_type;
