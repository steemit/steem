...
namespace steemit { namespace chain {
   ...
   struct transaction
   {
      ...
      void get_required_authorities( flat_set<aname_type>& active,
   ...
   void verify_authority( const vector<operation>& ops, const flat_set<public_key_type>& sigs,
                          ...
                          const flat_set<aname_type>& active_aprovals = flat_set<aname_type>(),
                          const flat_set<aname_type>& owner_aprovals = flat_set<aname_type>(),
                          const flat_set<aname_type>& posting_approvals = flat_set<aname_type>());
