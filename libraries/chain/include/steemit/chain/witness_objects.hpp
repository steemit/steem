...
namespace steemit {
    namespace chain {
        ...
        class witness_vote_object
                : public abstract_object<witness_vote_object> {
        public:
            static const uint8_t space_id = implementation_ids;
        ...
        typedef multi_index_container<
                ...
                indexed_by<
                        ...
                        std::greater<share_type>, std::less<string>>
        >,
        ...
        typedef multi_index_container<
                ...
                indexed_by<
                        ...
                        >,
                        composite_key_compare <
                        std::less<account_id_type>, std::less<witness_id_type>>
        >,
