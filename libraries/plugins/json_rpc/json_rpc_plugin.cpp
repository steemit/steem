            ...
            if( request.contains( "method" ) )
            {
               try
               {
                  ...
                  if( method == "call" )
                  {
                     ...
                     //All arguments in methods in 'condenser_api' are passed as vector of variants.
                     force_array = v[0].as_string() == "condenser_api";
                     if( v.size() == 3 )
                     {
                  ...
                  response.result = (*call)( force_array?( std::vector< fc::variant >(1, params) ):params );
               }
