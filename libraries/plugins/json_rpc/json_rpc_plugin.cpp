...
FC_REFLECT( dpn::plugins::json_rpc::detail::json_rpc_error, (code)(message)(data) )
FC_REFLECT( dpn::plugins::json_rpc::detail::json_rpc_response, (jsonrpc)(result)(error)(id) )

FC_REFLECT( dpn::plugins::json_rpc::detail::get_signature_args, (method) )
