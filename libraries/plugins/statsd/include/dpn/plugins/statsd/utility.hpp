#pragma once
#include <dpn/plugins/statsd/statsd_plugin.hpp>
...
using dpn::plugins::statsd::statsd_plugin;
...
{                                                        \
   dpn::plugins::statsd::util::get_statsd().increment( \
...
if( dpn::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   dpn::plugins::statsd::util::get_statsd().decrement( \
      NAMESPACE, STAT, KEY, FREQ                         \
   );                                                    \
}
...
if( dpn::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   dpn::plugins::statsd::util::get_statsd().count(     \
...
if( dpn::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   dpn::plugins::statsd::util::get_statsd().gauge(     \
      NAMESPACE, STAT, KEY, VAL, FREQ                    \
   );                                                    \
}
...
fc::optional< dpn::plugins::statsd::util::statsd_timer_helper > statsd_timer;  \
if( dpn::plugins::statsd::util::statsd_enabled() )                             \
{                                                                                \
   statsd_timer = dpn::plugins::statsd::util::statsd_timer_helper(             \
      NAMESPACE, STAT, KEY, FREQ, dpn::plugins::statsd::util::get_statsd()     \
   );                                                                            \
}
...
{                                                        \
   dpn::plugins::statsd::util::get_statsd().timing(    \
      NAMESPACE, STAT, KEY,                              \
      dpn::plugins::statsd::util::timing_helper( VAL ),\
      FREQ                                               \
   );                                                    \
}
