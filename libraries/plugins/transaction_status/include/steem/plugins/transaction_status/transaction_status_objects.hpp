...
#define STEEM_TRANSACTION_STATUS_SPACE_ID 18
   ...
   typedef multi_index_container<
      ...
      indexed_by<
         ordered_unique< tag< by_id >, member< transaction_object, transaction_status_object_id_type, &transaction_status_object::id > >,
...
FC_REFLECT_ENUM( steem::plugins::transaction_status::transaction_status_codes,
                (unknown)
                (processing)
                (accepted)
                (pending)
