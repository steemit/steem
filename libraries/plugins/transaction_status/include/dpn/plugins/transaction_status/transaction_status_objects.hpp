...
#ifndef DPN_TRANSACTION_STATUS_SPACE_ID
#define DPN_TRANSACTION_STATUS_SPACE_ID 18
#endif

enum transaction_status_object_type
{
   transaction_status_object_type = ( DPN_TRANSACTION_STATUS_SPACE_ID << 8 )
};
...
FC_REFLECT_ENUM( dpn::plugins::transaction_status::transaction_status,
                (unknown)
                (within_mempool)
...
FC_REFLECT( dpn::plugins::transaction_status::transaction_status_object, (id)(transaction_id)(block_num) )
CHAINBASE_SET_INDEX_TYPE( dpn::plugins::transaction_status::transaction_status_object, dpn::plugins::transaction_status::transaction_status_index )
