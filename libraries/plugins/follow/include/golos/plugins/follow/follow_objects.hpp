...
#include <golos/plugins/follow/follow_plugin.hpp>

#include <golos/plugins/chain/steem_object_types.hpp>
 ...
 */
            ...
            indexed_by<
                    ordered_unique < tag <
                    by_id>, member<blog_author_stats_object, blog_author_stats_id_type, &blog_author_stats_object::id>>,
            ...
            indexed_by<
                    ordered_unique < tag <
                    by_id>, member<reputation_object, reputation_id_type, &reputation_object::id>>,
            ...
            indexed_by<
                    ordered_unique < tag <
                    by_id>, member<follow_count_object, follow_count_id_type, &follow_count_object::id>>,
...
FC_REFLECT(golos::plugins::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id))
...
CHAINBASE_SET_INDEX_TYPE(golos::follow::reputation_object, golos::plugins::follow::reputation_index)
...
CHAINBASE_SET_INDEX_TYPE(golos::plugins::follow::blog_author_stats_object, golos::plugins::follow::blog_author_stats_index);
