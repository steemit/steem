...
FC_REFLECT( steemit::plugins::database_api::account_api_obj,
...
FC_REFLECT( steemit::plugins::database_api::owner_authority_history_api_obj,
             (id)
             (account)
...
FC_REFLECT( steemit::plugins::database_api::savings_withdraw_api_obj,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( steemit::plugins::database_api::tag_api_obj,
            (name)
            (total_payouts)
            (net_votes)
            (top_posts)
...
FC_REFLECT( steemit::plugins::database_api::witness_api_obj,
             (id)
             (owner)
             (created)
...
FC_REFLECT_DERIVED( steemit::plugins::database_api::signed_block_api_obj, (steemit::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT_DERIVED( steemit::plugins::database_api::dynamic_global_property_api_obj, (steemit::chain::dynamic_global_property_object),
