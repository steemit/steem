...
struct api_comment_object
{
   api_comment_object( const comment_object& o, const database& db ):
      ...
      percent_dpn_dollars( o.percent_dpn_dollars ),
...
struct api_account_object
{
   api_account_object( const account_object& a, const database& db ) :
      ...
      savings_dbd_balance( a.savings_dbd_balance ),
      ...
      reward_dbd_balance( a.reward_dbd_balance ),
      reward_dpn_balance( a.reward_dpn_balance ),
      reward_vesting_balance( a.reward_vesting_balance ),
      reward_vesting_dpn( a.reward_vesting_dpn ),
   ...
   asset             reward_dbd_balance;
   asset             reward_dpn_balance;
   asset             reward_vesting_balance;
   asset             reward_vesting_dpn;
...
{
   price                order_price;
   double               real_price; // dollars per dpn
   share_type           dpn;
   share_type           dbd;
...
FC_REFLECT( dpn::plugins::database_api::api_comment_object,
             (id)(author)(permlink)
...
FC_REFLECT( dpn::plugins::database_api::api_comment_vote_object,
             (id)(voter)(author)(permlink)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )

FC_REFLECT( dpn::plugins::database_api::api_account_object,
...
FC_REFLECT( dpn::plugins::database_api::api_owner_authority_history_object,
             (id)
             (account)
...
FC_REFLECT( dpn::plugins::database_api::api_account_recovery_request_object,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( dpn::plugins::database_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( dpn::plugins::database_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( dpn::plugins::database_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( dpn::plugins::database_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT_DERIVED( dpn::plugins::database_api::api_signed_block_object, (dpn::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT( dpn::plugins::database_api::api_hardfork_property_object,
            (id)
            (processed_hardforks)
            (last_hardfork)
...
FC_REFLECT( dpn::plugins::database_api::api_smt_token_object,
   (token)
   (ico)
)
...
FC_REFLECT_ENUM( dpn::plugins::database_api::proposal_status,
                  (all)
                  (inactive)
                  (active)
                  (expired)
...
FC_REFLECT( dpn::plugins::database_api::api_proposal_object,
            (id)
            (proposal_id)
            (creator)
            (receiver)
...
FC_REFLECT( dpn::plugins::database_api::api_proposal_vote_object,
            (id)
            (voter)
            (proposal)
          )

FC_REFLECT( dpn::plugins::database_api::order, (order_price)(real_price)(dpn)(dbd)(created) );

FC_REFLECT( dpn::plugins::database_api::order_book, (asks)(bids) );
