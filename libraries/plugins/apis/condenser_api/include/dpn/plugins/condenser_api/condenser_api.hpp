...
struct api_account_object
{
   api_account_object( const database_api::api_account_object& a ) :
      ...
      dbd_balance( legacy_asset::from_asset( a.dbd_balance ) ),
      dbd_seconds( a.dbd_seconds ),
      dbd_seconds_last_update( a.dbd_seconds_last_update ),
      dbd_last_interest_payment( a.dbd_last_interest_payment ),
      savings_dbd_balance( legacy_asset::from_asset( a.savings_dbd_balance ) ),
      savings_dbd_seconds( a.savings_dbd_seconds ),
      savings_dbd_seconds_last_update( a.savings_dbd_seconds_last_update ),
      savings_dbd_last_interest_payment( a.savings_dbd_last_interest_payment ),
      savings_withdraw_requests( a.savings_withdraw_requests ),
      reward_dbd_balance( legacy_asset::from_asset( a.reward_dbd_balance ) ),
      reward_dpn_balance( legacy_asset::from_asset( a.reward_dpn_balance ) ),
      reward_vesting_balance( legacy_asset::from_asset( a.reward_vesting_balance ) ),
      reward_vesting_dpn( legacy_asset::from_asset( a.reward_vesting_dpn ) ),
   ...
   legacy_asset      dbd_balance;
   uint128_t         dbd_seconds;
   time_point_sec    dbd_seconds_last_update;
   time_point_sec    dbd_last_interest_payment;

   legacy_asset      savings_dbd_balance;
   uint128_t         savings_dbd_seconds;
   time_point_sec    savings_dbd_seconds_last_update;
   time_point_sec    savings_dbd_last_interest_payment;

   uint8_t           savings_withdraw_requests = 0;

   legacy_asset      reward_dbd_balance;
   legacy_asset      reward_dpn_balance;
   legacy_asset      reward_vesting_balance;
   legacy_asset      reward_vesting_dpn;
...
struct extended_account : public api_account_object
{
   ...
   legacy_asset                                             vesting_balance;  /// convert vesting_shares to vesting dpn
...
struct api_comment_object
{
   api_comment_object( const database_api::api_comment_object& c ):
      ...
      percent_dpn_dollars( c.percent_dpn_dollars ),
   ...
   uint16_t          percent_dpn_dollars = 0;
...
struct extended_dynamic_global_properties
{
   ...
   extended_dynamic_global_properties( const database_api::api_dynamic_global_property_object& o ) :
      ...
      init_dbd_supply( legacy_asset::from_asset( o.init_dbd_supply ) ),
      current_dbd_supply( legacy_asset::from_asset( o.current_dbd_supply ) ),
      confidential_dbd_supply( legacy_asset::from_asset( o.confidential_dbd_supply ) ),
      total_vesting_fund_dpn( legacy_asset::from_asset( o.total_vesting_fund_dpn ) ),
      total_vesting_shares( legacy_asset::from_asset( o.total_vesting_shares ) ),
      total_reward_fund_dpn( legacy_asset::from_asset( o.total_reward_fund_dpn ) ),
      ...
      pending_rewarded_vesting_dpn( legacy_asset::from_asset( o.pending_rewarded_vesting_dpn ) ),
      dbd_interest_rate( o.dbd_interest_rate ),
      dbd_print_rate( o.dbd_print_rate ),
      ...
      dbd_stop_percent( o.dbd_stop_percent ),
      dbd_start_percent( o.dbd_start_percent )
   {}
   ...
   legacy_asset      init_dbd_supply;
   legacy_asset      current_dbd_supply;
   legacy_asset      confidential_dbd_supply;
   legacy_asset      total_vesting_fund_dpn;
   legacy_asset      total_vesting_shares;
   legacy_asset      total_reward_fund_dpn;
   fc::uint128       total_reward_shares2;
   legacy_asset      pending_rewarded_vesting_shares;
   legacy_asset      pending_rewarded_vesting_dpn;
...
struct api_witness_object
{
   ...
   api_witness_object( const database_api::api_witness_object& w ) :
      ...
      props( w.props ),
      dbd_exchange_rate( w.dbd_exchange_rate ),
      last_dbd_exchange_update( w.last_dbd_exchange_update ),
      votes( w.votes ),
   ...
   legacy_price            dbd_exchange_rate;
...
struct api_escrow_object
{
   ...
   api_escrow_object( const database_api::api_escrow_object& e ) :
      ...
      dbd_balance( legacy_asset::from_asset( e.dbd_balance ) ),
      dpn_balance( legacy_asset::from_asset( e.dpn_balance ) ),
...
struct discussion : public api_comment_object
{
   ...
   string                        root_title;
   legacy_asset                  pending_payout_value; ///< dbd
   legacy_asset                  total_pending_payout_value; ///< dbd including replies
...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v )
      :blockchain_version( bc_v ), dpn_revision( s_v ), fc_revision( fc_v ) {}

   fc::string blockchain_version;
   fc::string dpn_revision;
...
struct ticker
{
   ...
   ticker( const market_history::get_ticker_return& t ) :
      ...
      dpn_volume( legacy_asset::from_asset( t.dpn_volume ) ),
      dbd_volume( legacy_asset::from_asset( t.dbd_volume ) )
   {}
   ...
   legacy_asset   dpn_volume;
   legacy_asset   dbd_volume;
};
...
struct volume
{
   ...
   volume( const market_history::get_volume_return& v ) :
      dpn_volume( legacy_asset::from_asset( v.dpn_volume ) ),
      dbd_volume( legacy_asset::from_asset( v.dbd_volume ) )
   {}
...
FC_REFLECT( dpn::plugins::condenser_api::discussion_index,
...
FC_REFLECT( dpn::plugins::condenser_api::api_account_object,
             ...
             (reward_dbd_balance)(reward_dpn_balance)(reward_vesting_balance)(reward_vesting_dpn)
...
FC_REFLECT_DERIVED( dpn::plugins::condenser_api::extended_account, (dpn::plugins::condenser_api::api_account_object),
...
FC_REFLECT( dpn::plugins::condenser_api::api_comment_object,
             (id)(author)(permlink)
             ...
             (max_accepted_payout)(percent_dpn_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )

FC_REFLECT( dpn::plugins::condenser_api::extended_dynamic_global_properties,
            (head_block_number)(head_block_id)(time)
            (current_witness)(total_pow)(num_pow_witnesses)
            (virtual_supply)(current_supply)(confidential_supply)(init_dbd_supply)(current_dbd_supply)(confidential_dbd_supply)
            (total_vesting_fund_dpn)(total_vesting_shares)
            (total_reward_fund_dpn)(total_reward_shares2)(pending_rewarded_vesting_shares)(pending_rewarded_vesting_dpn)
            (dbd_interest_rate)(dbd_print_rate)
            ...
            (delegation_return_period)(reverse_auction_seconds)(dbd_stop_percent)(dbd_start_percent) )

FC_REFLECT( dpn::plugins::condenser_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( dpn::plugins::condenser_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT( dpn::plugins::condenser_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( dpn::plugins::condenser_api::api_reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
FC_REFLECT( dpn::plugins::condenser_api::api_escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (dbd_balance)(dpn_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )

FC_REFLECT( dpn::plugins::condenser_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( dpn::plugins::condenser_api::api_vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )

FC_REFLECT( dpn::plugins::condenser_api::api_vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )

FC_REFLECT( dpn::plugins::condenser_api::api_convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )

FC_REFLECT_DERIVED( dpn::plugins::condenser_api::discussion, (dpn::plugins::condenser_api::api_comment_object),
...
FC_REFLECT( dpn::plugins::condenser_api::scheduled_hardfork,
            (hf_version)(live_time) )

FC_REFLECT( dpn::plugins::condenser_api::account_vote,
            (authorperm)(weight)(rshares)(percent)(time) )

FC_REFLECT( dpn::plugins::condenser_api::tag_index, (trending) )

FC_REFLECT_ENUM( dpn::plugins::condenser_api::withdraw_route_type, (incoming)(outgoing)(all) )

FC_REFLECT( dpn::plugins::condenser_api::get_version_return,
            (blockchain_version)(dpn_revision)(fc_revision) )

FC_REFLECT( dpn::plugins::condenser_api::broadcast_transaction_synchronous_return,
            (id)(block_num)(trx_num)(expired) )

FC_REFLECT( dpn::plugins::condenser_api::comment_feed_entry,
            (comment)(reblog_by)(reblog_on)(entry_id) )

FC_REFLECT( dpn::plugins::condenser_api::comment_blog_entry,
            (comment)(blog)(reblog_on)(entry_id) )

FC_REFLECT( dpn::plugins::condenser_api::ticker,
            (latest)(lowest_ask)(highest_bid)(percent_change)(dpn_volume)(dbd_volume) )

FC_REFLECT( dpn::plugins::condenser_api::volume,
            (dpn_volume)(dbd_volume) )

FC_REFLECT( dpn::plugins::condenser_api::order,
            (order_price)(real_price)(dpn)(dbd)(created) )

FC_REFLECT( dpn::plugins::condenser_api::order_book,
            (bids)(asks) )

FC_REFLECT( dpn::plugins::condenser_api::market_trade,
