...
{
   discussion( const steemit::chain::comment_object& o, const steemit::chain::database& db ) :
...
typedef discussion_query         get_discussions_by_payout_args;
typedef discussion_query_result  get_discussions_by_payout_return;
