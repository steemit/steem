    ...
    namespace account_history {
        ...
        namespace detail {
            ...
            struct operation_visitor {
                operation_visitor(database &db, const operation_object &op, const operation_object *&n, string i)
                        : _db(db), op_obj(op), new_obj(n), item(i) {
                };
            ...
            struct operation_visitor_filter : operation_visitor {
                operation_visitor_filter(database &db, const operation_object &op, const operation_object *&n, string i)
                        : operation_visitor(db, op, n, i) {
                }
