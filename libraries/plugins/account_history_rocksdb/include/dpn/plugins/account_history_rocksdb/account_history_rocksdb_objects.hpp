...
#ifndef DPN_ACCOUNT_HISTORY_ROCKSDB_SPACE_ID
#define DPN_ACCOUNT_HISTORY_ROCKSDB_SPACE_ID 15
#endif
...
{
   volatile_operation_object_type = ( DPN_ACCOUNT_HISTORY_ROCKSDB_SPACE_ID << 8 )
};

class volatile_operation_object : public object< volatile_operation_object_type, volatile_operation_object >
{
   DPN_STD_ALLOCATOR_CONSTRUCTOR( volatile_operation_object )
...
} } } // dpn::plugins::account_history_rocksdb

FC_REFLECT( dpn::plugins::account_history_rocksdb::volatile_operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op)(impacted) )
CHAINBASE_SET_INDEX_TYPE( dpn::plugins::account_history_rocksdb::volatile_operation_object, dpn::plugins::account_history_rocksdb::volatile_operation_index )

FC_REFLECT( dpn::plugins::account_history_rocksdb::rocksdb_operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op) )
