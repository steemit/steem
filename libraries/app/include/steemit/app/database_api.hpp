...
FC_REFLECT(steemit::app::discussion_query, (tag)(filter_tags)(select_tags)(select_metadata_tags)(start_author)(start_permlink)(parent_author)(parent_permlink)(limit));
