...
namespace steemit {
    namespace chain2 {
        ...
        class block_object
                : public db2::object<block_object_type, block_object> {
        public:
        ...
        indexed_by<
                ordered_unique < tag <
                by_id>, member<block_object, block_object::id_type, &block_object::id>>,
        ...
        class transaction_object
                : public db2::object<transaction_object_type, transaction_object> {
        public:
            template<typename Constructor, typename Allocator>
