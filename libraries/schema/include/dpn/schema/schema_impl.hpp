...
#define DPN_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
DPN_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define DPN_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define DPN_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define DPN_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
DPN_DECLARE_SCHEMA_CLASS( false, false )
DPN_DECLARE_SCHEMA_CLASS(  true, false )
DPN_DECLARE_SCHEMA_CLASS(  true,  true )
