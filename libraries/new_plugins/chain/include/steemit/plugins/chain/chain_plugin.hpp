...
public:
   ...
   struct get_info_results
   {
      ...
      steemit::chain::block_id_type head_block_id;
      fc::time_point_sec head_block_time;
      steemit::chain::account_name_type head_block_producer;
   ...
   using get_block_results = optional< steemit::chain::signed_block >;
...
public:
   ...
   using push_block_params = steemit::chain::signed_block;
   using push_block_results = empty;
   push_block_results push_block( const push_block_params& params );

   using push_transaction_params = steemit::chain::signed_transaction;
...
FC_REFLECT( steemit::plugins::chain::chain_apis::empty, )
FC_REFLECT( steemit::plugins::chain::chain_apis::read_only::get_info_results,
            (head_block_num)(head_block_id)(head_block_time)(head_block_producer)
            (recent_slots)(participation_rate))
FC_REFLECT( steemit::plugins::chain::chain_apis::read_only::get_block_params, (block_num_or_id) )
