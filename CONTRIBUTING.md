...
Please read these instructions before submitting issues to the Dpn GitHub repository. The issue tracker is for bugs and specific implementation discussion **only**. It should not be used for other purposes, as described below.
...
## Dpnit.com vs. Dpn Blockchain

This issue tracker is only intended to track issues for the Dpn blockchain. If the issue is with the Dpnit.com website, please open an issue in the [Dpnit.com Repository](https://github.com/dpnit/dpnit.com/).
