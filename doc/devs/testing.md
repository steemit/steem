...
operation_tests      // Unit Tests of Dpn operations
operation_time_tests // Tests of Dpn operations that include a time based component (ex. vesting withdrawals)
...
```
cmake -D BUILD_DPN_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
