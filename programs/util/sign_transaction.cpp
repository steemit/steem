...
struct tx_signing_result {
    ...
    steemit::chain::public_key_type key;
    steemit::chain::signature_type sig;
};
...
int main(int argc, char **argv, char **envp) {
    ...
    while (std::cin) {
        ...
        sres.key = steemit::chain::public_key_type(priv_key.get_public_key());
