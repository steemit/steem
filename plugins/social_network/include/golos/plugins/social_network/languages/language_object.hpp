...
#define LANGUAGES_PLUGIN_NAME "languages"
    ...
    using language_name_type = fc::fixed_string<fc::sha256>;
        ...
        indexed_by<
            ...
            ordered_unique<
                ...
                composite_key<
                    ...
                    member<language_object, language_id_type, &language_object::id> >,
                composite_key_compare<
                    std::less<language_name_type>, std::less<comment_object::id_type>,
    ...
    using language_stats_id_type = object_id<language_stats_object> ;

    struct by_comments;
    struct by_top_posts;
    struct by_trending;

    using language_stats_index = multi_index_container<
        language_stats_object,
        indexed_by<
            ordered_unique<
                tag<by_id>,
    ...
    using author_tag_stats_id_type = object_id<author_language_stats_object>;
    ...
    using author_language_stats_index = multi_index_container <
        author_language_stats_object,
        indexed_by<
            ordered_unique<
                tag<by_id>,
            ...
            ordered_unique<
                ...
                composite_key_compare<
                    ...
                    greater<asset>,
                    less<account_object::id_type>>> >,
        allocator<author_language_stats_object>> ;
    ...
    inline std::string get_language(const comment_api_object& c) {
        if (!c.json_metadata.empty()) {
            try {
                return  fc::json::from_string(c.json_metadata).as<comment_metadata>().language;
            } catch (...) {
...
} } } } // golos::plugins::social_network::languages


FC_REFLECT(
    (golos::plugins::social_network::languages::comment_metadata), (language));

FC_REFLECT(
    (golos::plugins::social_network::languages::language_object),
...
FC_REFLECT(
    (golos::plugins::social_network::languages::language_stats_object),
...
FC_REFLECT(
    (golos::plugins::social_network::languages::peer_stats_object),
...
FC_REFLECT(
    (golos::plugins::social_network::languages::author_language_stats_object),
