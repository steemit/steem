...
if __name__ == '__main__':
    ...
    try:
        if node is None or node.is_running():
            ...
            proposal_data = [
                ['tester001', 1 + 0, 5, '240000.000 TBD'], # starts one day from now and lasts five days
                ['tester002', 1 + 0, 5, '24.000 TBD'], # starts one day from now and lasts two days
                ['tester003', 1 + 0, 5, '24.000 TBD'], # starts three days from now and lasts one day
                ['tester004', 1 + 0, 5, '24.000 TBD']  # starts four days from now and lasts one day
            ]
