    ...
    BOOST_AUTO_TEST_CASE(comment_apply) {
        try {
            ...
            db->modify(mod_sam_comment, [&](comment_object &com) {
                com.net_rshares = 10;
                com.abs_rshares = 10;
                com.children_rshares2 = db->calculate_vshares(10, com.root_comment_created);
            });
            ...
            db->modify(db->get_dynamic_global_properties(), [&](dynamic_global_property_object &o) {
                o.total_reward_shares2 = db->calculate_vshares(10, mod_alice_comment.root_comment_created);
            });
