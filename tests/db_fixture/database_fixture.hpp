...
struct t_proposal_database_fixture : public T
{
   ...
   steem::plugins::sps::list_proposals_return list_proposals(fc::variant _start, std::string _order_by, std::string _order_type, int _limit, steem::plugins::sps::proposal_status _status) ;
   steem::plugins::sps::list_voter_proposals_return list_voter_proposals(account_name_type _voter, std::string _order_by, std::string _order_type, int _limit, steem::plugins::sps::proposal_status _status) ;
