...
def main( ):
   ...
   if( not test_dir.exists() ):
      print "Test directory does not exist, creating it now...",
      sys.stdout.flush()
   ...
   print "Copying in blocks from existing blockchain...",
   sys.stdout.flush()
   ...
   print steemd
   print '--data-dir="' + str(test_data_dir) + '"'
   print "Starting up steemd with the debug node plugin...",
   sys.stdout.flush()
   ...
   try:
      ...
      while( True ):
         ...
         if( num_blocks % 100000 == 0 ):
            print "Blocks pushed: ", num_blocks
